...
import (
	...
	hellosvr "github.com/piotrostr/full-auto-gke/api/gen/grpc/hello/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, helloEndpoints *hello.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		helloServer = hellosvr.New(helloEndpoints, nil)
	}
	...
	hellopb.RegisterHelloServer(srv, helloServer)
