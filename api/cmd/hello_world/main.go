...
import (
	...
	helloworld "github.com/piotrostr/full-auto-gke/api"
...
func main() {
	...
	{
		logger = log.New(os.Stderr, "[helloworld] ", log.Ltime)
	}
	...
	{
		helloSvc = helloworld.NewHello(logger)
	}
	...
	case "localhost":
...

		{
			...
			handleGRPCServer(ctx, u, helloEndpoints, &wg, errc, logger, *dbgF)
		}
