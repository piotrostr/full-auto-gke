...
import (
	...
	helloc "github.com/piotrostr/full-auto-gke/api/gen/grpc/hello/client"
...
func UsageExamples() string {
	return os.Args[0] + ` hello say-hello --message '{
...
func ParseEndpoint(cc *grpc.ClientConn, opts ...grpc.CallOption) (goa.Endpoint, interface{}, error) {
	var (
		...
		helloSayHelloMessageFlag = helloSayHelloFlags.String("message", "", "")
	)
	...
	)
	{
		switch svcn {
		case "hello":
			c := helloc.NewClient(cc, opts...)
			switch epn {
			case "say-hello":
				endpoint = c.SayHello()
				data, err = helloc.BuildSayHelloPayload(*helloSayHelloMessageFlag)
			}
		}
	}
	if err != nil {
...
func helloSayHelloUsage() {
	fmt.Fprintf(os.Stderr, `%[1]s [flags] hello say-hello -message JSON

SayHello implements say-hello.
    -message JSON: 

Example:
    %[1]s hello say-hello --message '{
      "name": "Rerum a et sed reprehenderit quod."
   }'
`, os.Args[0])
}
